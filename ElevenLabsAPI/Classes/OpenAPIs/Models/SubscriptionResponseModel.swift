//
// SubscriptionResponseModel.swift
//
...
public struct SubscriptionResponseModel: Codable, JSONEncodable, Hashable {
    ...
    public init(tier: String, characterCount: Int, characterLimit: Int, canExtendCharacterLimit: Bool, allowedToExtendCharacterLimit: Bool, nextCharacterCountResetUnix: Int, voiceLimit: Int, canExtendVoiceLimit: Bool, canUseInstantVoiceCloning: Bool) {
        self.tier = tier
